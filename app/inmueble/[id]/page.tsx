...
// ventana mínima (permite contar visitas reales)
const TTL = 3 * 1000
const shouldTrack =
...
return () => {
const timeSpent = Math.max(1, Math.floor((Date.now() - start) / 1000))
const sentKey = `time_sent_${propertyId}_${sessionId}`
if (sessionStorage.getItem(sentKey)) return
sessionStorage.setItem(sentKey, "1")
fetch("https://casadata-api-production.up.railway.app/track-time", {
method: "POST",
headers: {
...
if (sessionStorage.getItem(sentKey)) return
sessionStorage.setItem(sentKey, "1")
fetch("https://casadata-api-production.up.railway.app/track-reach", {
method: "POST",
headers: {
"Content-Type": "application/json",
},
