...
import { MapPin, Phone, Home, Building, Car, Search, Navigation, Share, Menu, TrendingUp } from "lucide-react"
...
function PropertyCard({ property }: { property: Property }) {
  ...
  const getDemandLevel = (views: number) => {
    if (views > 200) return { level: "Alta", color: "bg-orange-100 text-orange-800" }
    if (views > 100) return { level: "Media", color: "bg-yellow-100 text-yellow-800" }
    return { level: "Normal", color: "bg-gray-100 text-gray-800" }
  }
      ...
      <Card className="overflow-hidden hover:shadow-lg transition-shadow cursor-pointer">
        <div className="relative">
          ...
          {property.isUserGenerated && (
            <Badge className="absolute top-2 right-2 bg-secondary text-secondary-foreground" variant="default">
              Nuevo
            </Badge>
          )}
          <Badge className={`absolute bottom-2 right-2 ${demand.color}`} variant="outline">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="max-w-md mx-auto">
            <div className="relative">
              ...
              <Input
                placeholder="Buscar por direccion o tipo..."
                value={searchTerm}
        ...
        <div className="max-w-7xl mx-auto px-4">
          {nearbyMode && (
            <div className="mb-6 p-4 bg-muted rounded-lg text-center">
              ...
              <p className="text-sm text-muted-foreground">Mostrando propiedades cerca de tu ubicacion</p>
            </div>
          )}
      ...
      <footer className="bg-card border-t mt-12">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="text-center">
            ...
            <p className="text-muted-foreground text-sm">Tu proximo hogar esta a un escaneo de distancia</p>
          </div>
        </div>
      </footer>
    </div>
